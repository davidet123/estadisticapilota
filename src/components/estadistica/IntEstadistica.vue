  ...
  <v-container fluid class="pa-0 my-0">
    ...
    <v-row>
      <v-col cols="4" align="center">
        ...
        <v-btn
          ...
          >INICI PARTIDA</v-btn
        >
        <v-btn x-small v-if="user && mostrar" @click="iniciPartida(false)"
          >FINAL PARTIDA</v-btn
        >
        <v-btn
          x-small
            ...
            <div align="center">
              <thead>
                <tr>
                  ...
                  <th width="80px" class="text-center" v-if="mostrar">
                    Eliminar
                  </th>
                </tr>
              </thead>
    ...
    <v-row>
      <v-col
        class="pa-0"
        :width="ancho"
        v-for="jugador in jugadors_rojos"
        :key="jugador.num"
      >
        <v-card class="caja">
            ...
            <v-row>
              ...
              >
                <Sustituciones
                  ...
                  posicion="jugador"
                  v-show="
                    partida.equip_roig.jugadors.length != jugadors_rojos.length
                  "
                />
              </v-col>
            </v-row>
            ...
            <v-row>
              <v-col cols="6" align="center">
                ...
                <v-btn
                  v-if="mostrar"
                  small
                  @click="colps(1, jugador.est_ind, jugador.nom)"
                  >+</v-btn
                >
                <v-btn
                  v-if="mostrar"
              ...
              <v-col cols="6" align="center">
                ...
                <v-btn
                  v-if="mostrar"
                  small
                  @click="errades(1, jugador.est_ind, jugador.nom)"
                  >+</v-btn
                >
                <v-btn
                  v-if="mostrar"
    ...
    <v-row>
      <v-col
        class="pa-0"
        :width="ancho"
        v-for="jugador in jugadors_blaus"
        :key="jugador.num"
      >
        <v-card class="caja">
            ...
            <v-row>
              ...
              >
                <Sustituciones
                  ...
                  posicion="jugador"
                  v-show="
                    partida.equip_blau.jugadors.length != jugadors_blaus.length
                  "
                />
              </v-col>
            </v-row>
            ...
            <v-row>
              <v-col cols="6" align="center">
                ...
                <v-btn
                  v-if="mostrar"
                  small
                  @click="tretes(1, treta_roig.tretes, treta_roig.nom)"
                  >+</v-btn
                >
                <v-btn
                  v-if="mostrar"
            ...
            <v-row>
              <v-col cols="6" align="center">
                ...
                <v-btn
                  small
                  v-if="mostrar"
                  @click="tretes(1, treta_blau.tretes, treta_blau.nom)"
                  >+</v-btn
                >
                <v-btn
                  small
          ...
          <v-row class="caja">
            <v-col cols="12" class="mx-auto" align="center">
              ...
              <v-row>
                <v-col cols="6" align="center">
                  <h3 class="red--text">
                    EQUIP ROIG {{ this.equip_roig.canvi_pilota }}
                  </h3>
                  <v-btn
                    v-if="mostrar"
                    small
            ...
            <v-col cols="12" class="mx-auto" align="center">
              ...
              <v-row>
                <v-col class="mt-0 pt-0" v-if="mostrar">
                  <v-btn small dark color="blue" @click="travesa('als blaus')"
                    >BLAUS</v-btn
                  >
                  <v-btn
                    small

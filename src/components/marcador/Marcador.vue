...
export default {
  ...
  computed: {
    ...
    parcial() {
      return this.joc_actual > 3 ? 3 : this.joc_actual;
    },
    marcador_total() {
    ...
    colps_ultim_quinze() {
      return this.partida.colps_ultim_quinze;
    },
    ultim_quinze() {
      let colps = this.partida.colps_ultim_quinze;
      let durada_quinze = this.partida.durada_quinze_str;

      return colps + " colps  |  " + durada_quinze;
    },
    user() {

  ...
  <v-container>
    <v-row>
      <v-col v-if="partides_actiu.length != 0">
        ...
        <v-sheet
          elevation="4"
          v-for="partida in partides_actiu"
          :key="partida.id"
        >
            ...
            <v-col cols="12" sm="5" class="pt-0">
              <v-row color="#f3f4f5">
                ...
                <v-col cols="3" align="center" class="my-0 py-0">
                  <h4 class="red--text">
                    {{ marcador(partida.id).marcador.jocs_rojos * 5 }}
                  </h4>
                </v-col>
                <v-col cols="3" class="red my-0 py-0" align="center">
                  <h4 class="white--text">
                    {{ punto_str[marcador(partida.id).marcador.punts_rojos] }}
                  </h4>
                </v-col>
                <v-col cols="3" class="blue my-0 py-0" align="center">
                  <h4 class="white--text">
                    {{ punto_str[marcador(partida.id).marcador.punts_blaus] }}
                  </h4>
                </v-col>
                <v-col cols="3" align="center" class="my-0 py-0">
                  <h4 class="blue--text">
                    {{ marcador(partida.id).marcador.jocs_blaus * 5 }}
                  </h4>
                </v-col>
    ...
    <v-row>
      <v-col v-if="partides_seguents.length != 0">
        ...
        <v-sheet
          elevation="4"
          v-for="partida in partides_seguents"
          :key="partida.id"
        >
    ...
    <v-row>
      <v-col v-if="partides_acabades.length != 0">
        ...
        <v-sheet
          elevation="4"
          v-for="partida in partides_acabades"
          :key="partida.id"
        >

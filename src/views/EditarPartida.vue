        ...
        <v-sheet elevation="4" widht="100%" class="px-4">
            ...
            <v-col cols="6">
              ...
              <v-col cols="12" v-for="(jug, index) in equip_roig" :key="index" class="my-0 py-0">
                <v-row>
                  ...
                  <v-col cols="1">
                    <v-checkbox v-model="jug.titular"></v-checkbox>
                  </v-col>
                </v-row>
              </v-col>
          ...
          <v-row>
            <v-col cols="6" class="mx-auto" align="center">
              <v-btn @click="crearPartida" color="#317f5c" dark class="mr-2 mb-2">crear partida</v-btn>
              <v-btn @click="crearGraella" color="#1d428a" dark class="mr-2 mb-2">validar Graella</v-btn>
            </v-col>
          </v-row>
        </v-sheet>
      </v-form>

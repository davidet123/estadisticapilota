...
export default {
  ...
  computed: {
    ...
    jugadores() {
      return this.partida.equip_roig.jugadors.concat(this.partida.equip_blau.jugadors)
    },
    url() {
      ...
      return 'http://192.168.1.92:8989/api/v1/documents/150934436/layers/88FF6A34-0690-472C-86C4-838E855955C5/variants/'
    },
    temps_total() {
